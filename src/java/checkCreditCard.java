 ...
 * @author Miki
 */
@WebServlet(urlPatterns = {"/checkCreditCard"})
public class checkCreditCard extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String creditCard = request.getParameter("c");
            if (db.checkCreditCard(userID,creditCard))
                response.sendRedirect("confirmPay.jsp");
            else
            {
                out.print("<div> Wrong Entry !</div><br><br>");
